...
#if DSP_MODEL==DSP_ST7567 || DSP_MODEL==DSP_ST7567I2C
...
const unsigned char logo [] PROGMEM=
{
  ...
  #if DSP_HSPI
    DspCore::DspCore(): ST7567(LCDWIDTH, LCDHEIGHT, &SPI2, TFT_DC, TFT_RST, TFT_CS, DEF_SPI_FREQ) {}
  #else
    DspCore::DspCore(): ST7567(LCDWIDTH, LCDHEIGHT, &SPI, TFT_DC, TFT_RST, TFT_CS, DEF_SPI_FREQ) {}
  #endif
#else
  #include <Wire.h>
  TwoWire I2CST7567 = TwoWire(0);
  DspCore::DspCore(): ST7567(LCDWIDTH, LCDHEIGHT, &I2CST7567, -1, I2CFREQ_HZ) {}
#endif
...
void DspCore::drawLogo(uint16_t top) {
  drawBitmap((width() - LOGO_WIDTH ) / 2, top, logo, LOGO_WIDTH, LOGO_HEIGHT, TFT_LOGO);
  display();
}
...
void DspCore::writeFillRect(int16_t x, int16_t y, int16_t w, int16_t h, uint16_t color) {
  ...
  ST7567::writeFillRect(x, y, w, h, color);
}
